...
import congratsBubbleSvg from '~/assets/images/l3/svg/congrats-bubble.svg'
import congratsAdv1DesktopSvg from '~/assets/images/l3/svg/congrats-adv1-desktop.svg'
import congratsAdv1MobileSvg from '~/assets/images/l3/svg/congrats-adv1-mobile.svg'
import congratsAdv2DesktopSvg from '~/assets/images/l3/svg/congrats-adv2-desktop.svg'
import congratsAdv2MobileSvg from '~/assets/images/l3/svg/congrats-adv2-mobile.svg'
import utpAgeSvg from '~/assets/images/l3/svg/utp-age.svg'
import utpCarsSvg from '~/assets/images/l3/svg/utp-cars.svg'
import utpMadeForKidsSvg from '~/assets/images/l3/svg/utp-made-for-kids.svg'
import utpOfflineSvg from '~/assets/images/l3/svg/utp-offline.svg'

import headPicPng from '~/assets/images/l3/png/head-pic.png'
import videoPreviewPng from '~/assets/images/l3/png/video-preview.png'
import cars2Video from '~/assets/videos/Cars2_1280x720.mp4'
import commasPng from '~/assets/images/l3/png/commas.png'
import starPng from '~/assets/images/l3/png/star.png'
...
// стандартным `PageView`, который уже шлёт сам загрузчик пикселя) — человек
// попал на лендинг. Только на клиенте: на SSR оба composable ничего не шлют,
// иначе событие задублировалось бы на гидрации.
const { track } = useL3Mixpanel()
const { trackCustom, trackPageView } = useL3MetaPixel()
