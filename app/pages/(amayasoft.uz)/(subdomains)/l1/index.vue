...
/* =========================================================
   ...
   Mobile-first. Breakpoints: base = ~375px phones,
   768px = tablet, 1024px = tablet landscape / small desktop.
...
/* =========================================================
   TABLET  (>= 768px) — matches the Figma "tablet" layout
   ========================================================= */
