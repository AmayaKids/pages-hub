...
import logoSvg from '~/assets/images/l4/svg/logo.svg'
import timerClockSvg from '~/assets/images/l4/svg/timer-clock.svg'
import offerCardSvg from '~/assets/images/l4/svg/offer-card.svg'
import offerCardDesktopSvg from '~/assets/images/l4/svg/offer-card-desktop.svg'
import offerBadgeSvg from '~/assets/images/l4/svg/offer-badge.svg'
import utpAgeSvg from '~/assets/images/l4/svg/utp-age.svg'
import utpCarsSvg from '~/assets/images/l4/svg/utp-cars.svg'
import utpMadeForKidsSvg from '~/assets/images/l4/svg/utp-made-for-kids.svg'
import utpOfflineSvg from '~/assets/images/l4/svg/utp-offline.svg'

import offerCityPng from '~/assets/images/l4/png/offer-city.png'
import offerPlanePng from '~/assets/images/l4/png/offer-plane.png'
import offerCarPng from '~/assets/images/l4/png/offer-car.png'
import checkSvg from '~/assets/images/l4/svg/check.svg'
import reviewStarsSvg from '~/assets/images/l4/svg/review-stars.svg'
import videoPreviewPng from '~/assets/images/l4/png/video-preview.png'
...
// гидрации.
const { track } = useL4Mixpanel()
const { trackCustom, trackPageView } = useL4MetaPixel()
...
/* =========================================================
   Лендинг l4 по макету Figma «Cars 1 / PW_locals_Cars1_UZ-3»,
...
.l4 {
  ...
  /* Сброса `h1, h2, h3, p { font-weight: 400 }` здесь намеренно нет: в
     scoped-стилях он превращается в `.l4 h1[data-v-…]`, что по
