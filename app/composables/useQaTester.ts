/**
 * Метка тестировщика — общая для лендингов l1 и l2 (у каждого свой домен,
 * значит и свой localStorage, но список пятерых тестировщиков один и тот же).
 *
 ...
 * свойством к каждому событию в Mixpanel (см. useL1Mixpanel.ts и
 * useL2Mixpanel.ts) — чтобы тестовый трафик можно было отфильтровать от
 * реального в отчётах. Ровно с этим и было связано расхождение цифр
 * Meta/Mixpanel, которое разбирали с Fedor.
 *
 * Баннер на странице (см. app/components/TesterBanner.vue) — обратная
